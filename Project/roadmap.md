...
| P1-4 | Move-to-folder | ⚠️ PARTIAL | Right-click → Move to (nested submenus, v0.11.7) works. **Toolbar Move button wired up** (T11, 2026-06-12) — opens the same folder picker via shared `Controls/FolderMoveMenu.cs`, targeting the selected message. Remaining: (b) honor multi-select once P1-12 lands. |
